import{aH as getDefaultExportFromCjs,_ as _export_sfc,e as useDisplay,b as useI18n,j as onMounted,f as ref,aE as GamePortFactor,O as watch,c as createElementBlock,o as openBlock,a as createVNode,w as withCtx,A as createBlock,D as createCommentVNode,F as Fragment,y as renderList,l as unref,v as createTextVNode,t as toDisplayString,s as VBtn,x as isRef,U as VListItem,E as mergeProps,z as withDirectives,J as VIcon,k as createBaseVNode,a8 as debounce,G as showSnackbar,aD as luaparse,aC as nextTick}from"./index-BXEKJlTw.js";import{C as CodeEditor}from"./CodeEditor-CAuMTS2P.js";import{g as groundWorldRule,_ as _sfc_main$1,o as overrides,a as groundWorldGeneration,c as cavesWorldRule,b as cavesWorldGeneration,d as caveOverrideWorldGenerationWorld}from"./levelDataSetting-YolszjyX.js";import{_ as __unplugin_components_0}from"./ConfirmBox--HKcqiTW.js";import{c as VTab,d as VTabs,e as VTabsWindowItem,f as VTabsWindow}from"./VTabs-uunpIqgI.js";import{V as VMenu}from"./VMenu-DeNXe2TW.js";import{V as VList}from"./VList-BjuBhsmq.js";import{V as VForm}from"./VForm-CB3qOKH-.js";import{V as VRow}from"./VRow-UeEmSdxo.js";import{V as VCol}from"./VCol-BlWyeu-n.js";import{V as VRadioGroup,a as VRadio}from"./VRadioGroup-C2nuH-GB.js";import{V as VChip}from"./VChip-FN_Hv0dz.js";import{T as Tooltip}from"./index-D-jROasW.js";import{V as VTextField}from"./VTextField-DWQktzyK.js";import{V as VNumberInput}from"./VNumberInput-AwC0SCMb.js";import{V as VAlert}from"./VAlert-DHIfGhaL.js";import"./VSpacer-QAaW9Sa9.js";import"./VDialog-CPebV_N-.js";import"./dialog-transition-Kx302Eug.js";import"./ssrBoot-CA6-2igt.js";import"./index-CGBjEpyQ.js";import"./VInput-nwNUonq6.js";import"./VSelectionControl-DmszpPxA.js";import"./VTooltip-ChDod2uS.js";var src={},luamin$1={exports:{}},hasRequiredLuamin;function requireLuamin(){return hasRequiredLuamin||(hasRequiredLuamin=1,(function(y){function w(F){for(var h=0,d=F.length;d--;)h+=F.charCodeAt(d),h+=h<<10,h^=h>>6;return h+=h<<3,h^=h>>11,h+=h<<15,h}const S=console.log,n=function(F,h){if(!F)throw h};function C(F,h){if(!F)return 0;var d=F.toString().split(".");return d.length>1?parseInt(d[0],h)+parseInt(d[1],h)/Math.pow(h,d[1].length):parseInt(d[0],h)}let B=[" ",`
`,"	","\r"],Q={r:"\r",n:`
